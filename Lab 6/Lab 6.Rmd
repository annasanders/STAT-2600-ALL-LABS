...
James: I used mainly the geom_point function to plot the conditional probabilities of being late given carrier. I labeled each graph using the labs function and included a horizontal line on one plot to indicate the probability of being late in general. 
