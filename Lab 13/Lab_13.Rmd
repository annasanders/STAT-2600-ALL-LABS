...
This question is important as HDI should not be influcenced by Population in any way. Countries with higher or lower populations should not be though of as less or more developed because development has little to do with population size. I chose to use a two sample correlation test to prove that there is no correlation. 
```{r, Eval=FALSE} 
hdi <- gapminder3%>% 
  select(HDI) 
