...
milk_bday <- milk %>%
  ...
  ggplot(data = milk_bday) + geom_col(mapping = aes(x=state, y =milk_million, fill=state)) +
   labs(x="States," y="Milk Produced (in millions of gallons)", title = "Milk Production by State in 1998" )
```
...
In 1998, the median milk production was ____ million gallons, and the mean milk  production was ____ million gallons. 
The state that produced the most amount of milk was ____ . The state that produced the least amount of milk was ____ .
