...
scale_x_continuous(limits=c(-0.0001,0.0025))+
...
Overall, Anna and Ann names are losing popularity comparivitly. It is important to note, however, Anna as a name has never been particularly popular.

I chose to use both a line plot and a histogram to best represent the change in total Ann and Anna names as well as the change in proportion of Anna to other Ann names. I used Anna$ to filter to my name as that would give me only the name Anna with the exact spelling I use. 
