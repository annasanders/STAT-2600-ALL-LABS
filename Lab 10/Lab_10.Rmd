...
If someone refers to a link in their answer, they are more likely to get a better score/upvote. We also found that some answers are scored higher than questions, but those answers are in the minority.
...
From the graph, you can see that there is a postive relationship between question score and the difference, meaning that the qustion has to be generally highly scored for an answer to have an even higher score. Similarly, most of the points where this happens only have a difference below 500 points. 
